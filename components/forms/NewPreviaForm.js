            ...
            <form className='grid grid-cols-3 gap-3' onSubmit={handleSubmit}>
                <div className="col-span-3 lg:col-span-2">
                    <div className='my-2'>
                        ...
                        />
                        {validations.location && <p className="text-red-500">{validations.location}</p>}
                    </div>
                    ...
                    <div className='flex flex-wrap justify-start gap-3  '>
                        <div className='w-50 my-3'>
                            ...
                            />
                            {validations.date && <p className="text-red-500">{validations.date}</p>}
                        </div>
                        ...
                        <div className='w-50 my-3'>
                            ...
                            />
                            {validations.startTime && <p className="text-red-500">{validations.startTime}</p>}
                        </div>
                    </div>
                    <div className='flex flex-wrap justify-start gap-3'>
                        <div className='w-50 my-3'>
                            ...
                            />
                            {validations.participants && <p className="text-red-500">{validations.participants}</p>}
                        </div>
                        <div className="w-50 my-3">
                            <Select
                                label="Where is it?"
                            ...
                            {validations.place_details && <p className="text-red-500">{validations.place_details}</p>}
                        </div>
                    </div>
                    <div className='flex items-center text-secondary gap-3 border-b-2 border-t-2 border-primary_b m-2'>
                        <Checkbox label="Show previa location"
                            id="show_location"
                            color='blue'
                            name="show_location"
                            onChange={handleChange}
                    ...
                    <div className='my-2'>
                        ...
                        />
                        {validations.description && <p className="text-red-500">{validations.description}</p>}
                    </div>
                </div>
                <div className="col-span-3 lg:col-span-1">
                    <div className="flex flex-wrap justify-center items-center gap-2">
                        <div className='text-secondary'>
                            {formData.images_previa_url && <img src={formData.images_previa_url} alt="previa pic preview" />}
                        </div>
                        ...
                        {validations.images_previa_url && <p className="text-red-500">{validations.images_previa_url}</p>}
                    </div>
                </div>
                {error && (
                ...
                <button className='btn-secondary mt-4 col-span-3' type="submit">{isLoading ? "Creating..." : "Save"} </button>
            </form>
