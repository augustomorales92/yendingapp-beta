...
export default function RequestJoinModal({ previa, onClose,setIsModalOpen }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await fetch('/api/previa/joinRequest', {
                ...
                body: JSON.stringify({ previaId: previa_id, joinRequest: newPreviaUser })
            });
    ...
    return (
        <div className="bg-primary_b max-w-full min-h-full my-4 px-8 py-4 mx-auto rounded-md">
            ...
            <div className='text-secondary text-md my-2'><b className='text-secondary_b'>{creatorName}</b>'s Previa in <b className='text-secondary_b'>{location}</b> at <b className='text-secondary_b'>{startTime}</b></div>
                ...
                <div className="col-span-3 lg:col-span-1">
                    <div className="flex flex-wrap justify-center items-center gap-2">
                        <div className='text-secondary'>
                            {photos ? <img className="max-w-full max-h-80 object-contain" src={photos} alt="profile pic preview" /> : <img src="" alt="pic preview" />}
                        </div>
