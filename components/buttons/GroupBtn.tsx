  ...
  return (
    <div className="flex justify-end space-x-4 mb-4">
      <div className="hidden md:flex space-x-4">
        <div className="justify-   flex items-center border rounded-md border-none gap-3">
          <button
            onClick={() => handleSearch('date')}
            className="flex text-xl text-secondary_b hover:bg-secondary/80 rounded-md p-3  focus:bg-secondary/80 bg-black"
          >
